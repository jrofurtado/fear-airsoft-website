...
import "../web/out/x-galeria-folder.dart";
import "../web/out/x-galeria.dart";
...
void galeriaFolderUnitTests(){
  group("Testes Unitarios GaleriaFolder:", (){
    ...
    setUp((){
      galeriaFolder = GaleriaFolder.forElement(new SpanElement());
      galeriaFolder.created_autogenerated();
      galeriaFolder.created();
...
void galeriaUnitTests(){
  group("Testes Unitarios Galeria:", (){
    Galeria galeria;
    setUp((){
      galeria = Galeria.forElement(new SpanElement());
      galeria.created_autogenerated();
      galeria.created();
