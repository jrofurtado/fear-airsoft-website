...
class TokenChar {
  ...
  static const int LPAREN = 0x28; // "(".charCodeAt(0)
  static const int RPAREN = 0x29; // ")".charCodeAt(0)
  static const int LBRACK = 0x5b; // "[".charCodeAt(0)
  static const int RBRACK = 0x5d; // "]".charCodeAt(0)
  static const int LBRACE = 0x7b; // "{".charCodeAt(0)
  static const int RBRACE = 0x7d; // "}".charCodeAt(0)
  static const int DOT = 0x2e; // ".".charCodeAt(0)
  static const int SEMICOLON = 0x3b; // ";".charCodeAt(0)
  static const int AT = 0x40; // "@".charCodeAt(0)
  static const int HASH = 0x23; // "#".charCodeAt(0)
  static const int PLUS = 0x2b; // "+".charCodeAt(0)
  static const int GREATER = 0x3e; // ">".charCodeAt(0)
  static const int TILDE = 0x7e; // "~".charCodeAt(0)
  static const int ASTERISK = 0x2a; // "*".charCodeAt(0)
  static const int NAMESPACE = 0x7c; // "|".charCodeAt(0)
  static const int COLON = 0x3a; // ":".charCodeAt(0)
  static const int PRIVATE_NAME = 0x5f; // "_".charCodeAt(0)
  static const int COMMA = 0x2c; // ",".charCodeAt(0)
  static const int SPACE = 0x20; // " ".charCodeAt(0)
  ...
  static const int SLASH = 0x2f; // "/".charCodeAt(0)
  static const int EQUALS = 0x3d; // "=".charCodeAt(0)
  static const int OR = 0x7c; // "|".charCodeAt(0)
  static const int CARET = 0x5e; // "^".charCodeAt(0)
  static const int DOLLAR = 0x24; // "\$".charCodeAt(0)
