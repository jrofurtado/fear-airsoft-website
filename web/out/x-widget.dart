...
class Widget extends WebComponent {
  ...
  static final __shadowTemplate = new autogenerated.DocumentFragment.html('''
        <div class="widget " id="__e-112">
          <div class="widget-title"><h3 id="__e-111"></h3></div>
          <div class="widget-content"><content></content></div>
        </div>
      ''');
  autogenerated.DivElement __e112;
  autogenerated.HeadingElement __e111;
  ...
  void created_autogenerated() {
    ...
    var __binding110 = __t.contentBind(() => titulo, false);
    __e111.nodes.add(__binding110);
    __t.bindClass(__e112, () => cssClass, false);
    __t.create();
  }
