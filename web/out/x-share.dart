...
class Share extends WebComponent {
  ...
  static final __shadowTemplate = new autogenerated.DocumentFragment.html('''
        <a id="__e-195"><img class="shareImg" title="Partilhar no facebook" src="../share-facebook.png" alt="Partilhar no Facebook"></a>
      ''');
  ...
  void created_autogenerated() {
    ...
    __e195 = _root.query('#__e-195');
    __t.oneWayBind(() => facebookShareUrl, (e) { __e195.href = e; }, false, true);
    __t.create();
  }
