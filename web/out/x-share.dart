...
class Share extends WebComponent {
  ...
  Share.forElement(e) : super.forElement(e);
  ...
  void created_autogenerated() {
    ...
    _root.innerHtml = '''
        <a id="__e-169"><img class="shareImg" title="Partilhar no facebook" src="../share-facebook.png" alt="Partilhar no Facebook"></a>
      ''';
    __e169 = _root.query('#__e-169');
    __t.oneWayBind(() => facebookShareUrl, (e) { __e169.href = e; }, false, true);
    __t.create();
  }
