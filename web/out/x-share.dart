...
class Share extends WebComponent {
  ...
  static final __shadowTemplate = new autogenerated.DocumentFragment.html('''
        <a id="__e-183"><img class="shareImg" title="Partilhar no facebook" src="../share-facebook.png" alt="Partilhar no Facebook"></a>
      ''');
  autogenerated.AnchorElement __e183;
  ...
  void created_autogenerated() {
    ...
    __e183 = _root.query('#__e-183');
    __t.oneWayBind(() => facebookShareUrl, (e) { __e183.href = e; }, false, true);
    __t.create();
  }
