...
class Share extends WebComponent {
  ...
  void created_autogenerated() {
    ...
    _root.innerHtml = '''
        <a id="__e-171"><img class="shareImg" title="Partilhar no facebook" src="../share-facebook.png" alt="Partilhar no Facebook"></a>
      ''';
    __e171 = _root.query('#__e-171');
    __t.oneWayBind(() => facebookShareUrl, (e) { __e171.href = e; }, false, true);
    __t.create();
  }
