...
class ButtonNav extends WebComponent {
   ...
   */
  var _root;
  autogenerated.AnchorElement __e102;
  ...
  void created_autogenerated() {
    ...
    _root.innerHtml = '''
        <a class="navlink" id="__e-102"></a>
      ''';
    __e102 = _root.query('#__e-102');
    var __binding101 = __t.contentBind(() => navlink.name, false);
    __e102.nodes.add(__binding101);
    __t.listen(__e102.onClick, ($event) { click(); });
    __t.oneWayBind(() => navlink.link, (e) { __e102.href = e; }, false, true);
    __t.create();
  }
