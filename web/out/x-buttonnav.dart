...
class ButtonNav extends WebComponent {
   ...
   */
  var _root;
  autogenerated.AnchorElement __e97;
  ...
  void created_autogenerated() {
    ...
    _root.innerHtml = '''
        <a class="navlink" id="__e-97"></a>
      ''';
    __e97 = _root.query('#__e-97');
    var __binding96 = __t.contentBind(() => navlink.name, false);
    __e97.nodes.add(__binding96);
    __t.listen(__e97.onClick, ($event) { click(); });
    __t.oneWayBind(() => navlink.link, (e) { __e97.href = e; }, false, true);
    __t.create();
  }
