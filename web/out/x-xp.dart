...
class Xp extends WebComponent {
   ...
   */
  var _root;
  autogenerated.DivElement __e176;
  autogenerated.ParagraphElement __e175, __e178;
  ...
  void created_autogenerated() {
    ...
    var __binding174 = __t.contentBind(() => membro['previousLevelXp'], false);
    __e175.nodes.add(__binding174);
    __e176 = _root.query('#__e-176');
    __t.bind(() => larguraXp,  (__e) { __e176.attributes['style'] = 'width:${__e.newValue}%;'; }, false);
    __e178 = _root.query('#__e-178');
    var __binding177 = __t.contentBind(() => membro['nextLevelXp'], false);
    __e178.nodes.add(__binding177);
    __t.create();
  }
