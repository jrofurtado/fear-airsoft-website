...
class AnuncioItem extends WebComponent {
   ...
   */
  var _root;
  static final __html1 = new autogenerated.Element.html('<div class="anuncio-item-title">\n              <a id="__e-75"></a>\n            </div>'), __html2 = new autogenerated.Element.tag('template'), __html3 = new autogenerated.Element.html('<a><img class="anuncio-item-imagem" id="__e-77"></a>'), __html4 = new autogenerated.Element.html('<div class="anuncio-item-title">\n              <a target="_blank" id="__e-82"></a>\n            </div>'), __html5 = new autogenerated.Element.tag('template'), __html6 = new autogenerated.Element.html('<a target="_blank"><img class="anuncio-item-imagem" id="__e-84"></a>'), __html7 = new autogenerated.Element.html('<div class="anuncio-item-title"></div>'), __html8 = new autogenerated.Element.tag('template'), __html9 = new autogenerated.Element.html('<img class="anuncio-item-imagem">'), __shadowTemplate = new autogenerated.DocumentFragment.html('''
  ...
  void created_autogenerated() {
    ...
    __t.component(new Share.forElement(__e95));
    __t.create();
  }
