...
class PaginaClube extends WebComponent {
  ...
  autogenerated.Element __e38, __e42, __e44;
  autogenerated.Template __t;
  autogenerated.UnknownElement __e39, __e40, __e45, __e46;
  ...
  void created_autogenerated() {
    ...
    _root.innerHtml = '''
        <x-widget tamanho="small" titulo="Próximo Jogo" id="__e-39">
...
O clube de praticantes FEAR tem como principal objetivo a promoção do airsoft na ilha de São Miguel nos Açores, permitindo aos seus associados a prática da modalidade, cumprindo os preceitos legais para o efeito.
    ...
    __map_canvas = __e39.query('#map_canvas');
    __e38 = __e39.query('#__e-38');
    __t.conditional(__e38, () => weatherProximoJogo!=null, (__t) {
      var __e30, __e33, __e35, __e37;
      __e30 = new autogenerated.ImageElement();
      __t.oneWayBind(() => weatherProximoJogo['weatherIconUrl'][0]['value'], (e) { __e30.src = e; }, false, true);
      __e33 = new autogenerated.Element.html('<span class="weatherSmallText "></span>');
      var __binding31 = __t.contentBind(() => weatherProximoJogo['tempMinC'], false);
      var __binding32 = __t.contentBind(() => weatherProximoJogo['tempMaxC'], false);
      __e33.nodes.addAll([__binding31,
          new autogenerated.Text('º C - '),
          __binding32,
          new autogenerated.Text('º C')]);
      __t.bindClass(__e33, () => temperaturaClass, false);
      __e35 = new autogenerated.Element.html('<span class="weatherSmallText "></span>');
      var __binding34 = __t.contentBind(() => weatherProximoJogo['precipMM'], false);
      __e35.nodes.addAll([new autogenerated.Text('Precipitação: '),
          __binding34,
          new autogenerated.Text(' mm')]);
      __t.bindClass(__e35, () => precipitacaoClass, false);
      __e37 = new autogenerated.Element.html('<span class="weatherSmallText "></span>');
      var __binding36 = __t.contentBind(() => weatherProximoJogo['windspeedKmph'], false);
      __e37.nodes.addAll([new autogenerated.Text('Vento (Km/h): '),
          __binding36,
          new autogenerated.Text(' Km/h')]);
      __t.bindClass(__e37, () => ventoClass, false);
    ...
    __t.bind(() => null,  (__e) { __e39.xtag.titulo = 'Próximo Jogo'; }, true);
    new Widget.forElement(__e39);
    __t.component(__e39);
    __e40 = _root.query('#__e-40');
    __t.bind(() => null,  (__e) { __e40.xtag.tamanho = 'small'; }, true);
    __t.bind(() => null,  (__e) { __e40.xtag.titulo = 'Contacto'; }, true);
    new Widget.forElement(__e40);
    __t.component(__e40);
    __e45 = _root.query('#__e-45');
    __e42 = __e45.query('#__e-42');
    __t.conditional(__e42, () => anunciosRecentes.length==0, (__t) {
      var __e41;
      __e41 = new autogenerated.Element.tag('x-loading');
      new Loading.forElement(__e41);
      __t.component(__e41);
    __t.addAll([new autogenerated.Text('\n            '),
        __e41,
        new autogenerated.Text('\n          ')]);
    ...
    __e44 = __e45.query('#__e-44');
    __t.loop(__e44, () => anunciosRecentes, (anuncio, __t) {
      var __e43;
      __e43 = new autogenerated.Element.tag('x-anuncio-item');
      __t.oneWayBind(() => anuncio, (e) { __e43.xtag.anuncio = e; }, false, false);
      new AnuncioItem.forElement(__e43);
      __t.component(__e43);
    __t.addAll([new autogenerated.Text('\n            '),
        __e43,
        new autogenerated.Text('\n          ')]);
    });
    __t.bind(() => null,  (__e) { __e45.xtag.tamanho = 'small'; }, true);
    __t.bind(() => null,  (__e) { __e45.xtag.titulo = 'Anúncios Recentes'; }, true);
    new Widget.forElement(__e45);
    __t.component(__e45);
    __e46 = _root.query('#__e-46');
    __t.bind(() => null,  (__e) { __e46.xtag.tamanho = 'small'; }, true);
    __t.bind(() => null,  (__e) { __e46.xtag.titulo = 'História'; }, true);
    new Widget.forElement(__e46);
    __t.component(__e46);
    __t.create();
  }
  ...
  void removed_autogenerated() {
    __t.remove();
    __t = __e39 = __map_canvas = __e38 = __e40 = __e45 = __e42 = __e44 = __e46 = null;
  }
