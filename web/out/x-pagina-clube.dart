...
O clube de praticantes FEAR tem como principal objetivo a promoção do airsoft na ilha de São Miguel nos Açores, permitindo aos seus associados a prática da modalidade, cumprindo os preceitos legais para o efeito.
    ...
    __t.conditional(__e31, () => model.tempo.length>0, (__t) {
      var __e23, __e26, __e28, __e30;
      __e23 = new autogenerated.ImageElement();
      __t.oneWayBind(() => model.tempo[0]['weatherIconUrl'][0]['value'], (e) { __e23.src = e; }, false, true);
      __e26 = new autogenerated.Element.html('<span class="weatherSmallText "></span>');
      var __binding24 = __t.contentBind(() => model.tempo[0]['tempMinC'], false);
      var __binding25 = __t.contentBind(() => model.tempo[0]['tempMaxC'], false);
      ...
      var __binding27 = __t.contentBind(() => model.tempo[0]['precipMM'], false);
      ...
      var __binding29 = __t.contentBind(() => model.tempo[0]['windspeedKmph'], false);
