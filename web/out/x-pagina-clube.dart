...
class PaginaClube extends WebComponent {
  ...
  static final __html1 = new autogenerated.Element.html('<x-widget tamanho="large" titulo="Próximo Jogo">\n            Não há jogos marcados\n          </x-widget>'), __html2 = new autogenerated.Element.html('<x-widget tamanho="large">\n            <x-jogo id="__e-33"></x-jogo>\n          </x-widget>'), __html3 = new autogenerated.Element.tag('x-loading'), __html4 = new autogenerated.Element.tag('x-anuncio-item'), __shadowTemplate = new autogenerated.DocumentFragment.html('''
        <x-widget tamanho="small" titulo="Contacto" id="__e-29">
...
O clube de praticantes FEAR tem como principal objetivo a promoção do airsoft na ilha de São Miguel nos Açores, permitindo aos seus associados a prática da modalidade, cumprindo os preceitos legais para o efeito.
      ...
      ''');
  autogenerated.Element __e32, __e35, __e37, __e39;
  autogenerated.Template __t;
  autogenerated.UnknownElement __e29, __e30, __e40, __e41;
  ...
  void created_autogenerated() {
    ...
    __t.bind(() => null,  (__e) { __e29.xtag.tamanho = 'small'; }, true);
    __t.bind(() => null,  (__e) { __e29.xtag.titulo = 'Contacto'; }, true);
    __t.component(new Widget.forElement(__e29));
    __e30 = _root.query('#__e-30');
    __t.bind(() => null,  (__e) { __e30.xtag.tamanho = 'small'; }, true);
    __t.bind(() => null,  (__e) { __e30.xtag.titulo = 'Redes Sociais'; }, true);
    __t.component(new Widget.forElement(__e30));
    __e32 = _root.query('#__e-32');
    __t.conditional(__e32, () => model.jogo.length==0, (__t) {
      var __e31;
      __e31 = __html1.clone(true);
      __t.bind(() => null,  (__e) { __e31.xtag.tamanho = 'large'; }, true);
      __t.bind(() => null,  (__e) { __e31.xtag.titulo = 'Próximo Jogo'; }, true);
      __t.component(new Widget.forElement(__e31));
    ...
    __t.conditional(__e35, () => model.jogo.length>0, (__t) {
      var __e33, __e34;
      __e34 = __html2.clone(true);
      __e33 = __e34.query('#__e-33');
      __t.component(new Jogo.forElement(__e33));
      __t.bind(() => null,  (__e) { __e34.xtag.tamanho = 'large'; }, true);
      __t.bind(() => [model.jogo[0]['nome'], model.jogo[0]['dia'], model.jogo[0]['mes'], model.jogo[0]['ano']],  (__e) { __e34.xtag.titulo = '${__e.newValue[0]} ${__e.newValue[1]}/${__e.newValue[2]}/${__e.newValue[3]}'; }, false);
      __t.component(new Widget.forElement(__e34));
    __t.addAll([new autogenerated.Text('\n          '),
        __e34,
        new autogenerated.Text('\n        ')]);
    });
    ...
    __t.conditional(__e37, () => anunciosRecentes.length==0, (__t) {
      var __e36;
      __e36 = __html3.clone(true);
      __t.component(new XLoading.forElement(__e36));
    __t.addAll([new autogenerated.Text('\n            '),
        __e36,
        new autogenerated.Text('\n          ')]);
    });
    ...
    __t.loop(__e39, () => anunciosRecentes, (anuncio, __t) {
      var __e38;
      __e38 = __html4.clone(true);
      __t.oneWayBind(() => anuncio, (e) { __e38.xtag.anuncio = e; }, false, false);
      __t.component(new AnuncioItem.forElement(__e38));
    __t.addAll([new autogenerated.Text('\n            '),
        __e38,
        new autogenerated.Text('\n          ')]);
    });
  ...
  void removed_autogenerated() {
    __t.remove();
    __t = __e29 = __e30 = __e32 = __e35 = __e40 = __e37 = __e39 = __e41 = null;
  }
