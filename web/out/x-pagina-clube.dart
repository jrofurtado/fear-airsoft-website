...
class PaginaClube extends WebComponent {
   ...
   */
  var _root;
  static final __html1 = new autogenerated.Element.html('<x-widget tamanho="small">\n            <x-jogo id="__e-23"></x-jogo>       \n          </x-widget>'), __html2 = new autogenerated.Element.tag('x-loading'), __html3 = new autogenerated.Element.tag('x-anuncio-item'), __shadowTemplate = new autogenerated.DocumentFragment.html('''
