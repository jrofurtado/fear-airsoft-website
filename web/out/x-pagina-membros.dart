...
class PaginaMembros extends WebComponent {
   ...
   */
  var _root;
  autogenerated.Element __e49, __e51, __e53, __e55;
  autogenerated.InputElement __e47;
  ...
  void created_autogenerated() {
    ...
    __t.conditional(__e49, () => model.membros.length==0, (__t) {
      var __e48;
      __e48 = new autogenerated.Element.tag('x-loading');
      new Loading.forElement(__e48);
      __t.component(__e48);
    ...
    __t.conditional(__e51, () => membroEscolhido!=null, (__t) {
      var __e50;
      __e50 = new autogenerated.Element.tag('x-member');
      __t.oneWayBind(() => membroEscolhido, (e) { __e50.xtag.membro = e; }, false, false);
      new Member.forElement(__e50);
      __t.component(__e50);
    __t.addAll([new autogenerated.Text('\n          '),
        __e50,
        new autogenerated.Text('\n        ')]);
    ...
    __t.loop(__e53, () => resultados, (membro, __t) {
      var __e52;
      __e52 = new autogenerated.Element.tag('x-member-item');
      __t.oneWayBind(() => membro, (e) { __e52.xtag.membro = e; }, false, false);
      new MemberItem.forElement(__e52);
      __t.component(__e52);
    __t.addAll([new autogenerated.Text('\n          '),
        __e52,
        new autogenerated.Text('\n        ')]);
    ...
    __t.conditional(__e55, () => model.emblemaSeleccionado!=null, (__t) {
      var __e54;
      __e54 = new autogenerated.Element.tag('x-legenda-emblema');
      __t.oneWayBind(() => model.emblemaSeleccionado, (e) { __e54.xtag.nome = e; }, false, false);
      new LegendaEmblema.forElement(__e54);
      __t.component(__e54);
    __t.addAll([new autogenerated.Text('\n          '),
        __e54,
        new autogenerated.Text('\n        ')]);
  ...
  void removed_autogenerated() {
    __t.remove();
    __t = __e47 = __e49 = __e51 = __e53 = __e55 = null;
  }
