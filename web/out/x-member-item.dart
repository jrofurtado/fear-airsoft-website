...
class MemberItem extends WebComponent {
  ...
  void created_autogenerated() {
    ...
    __t.conditional(__e140, () => membro['achievementsGun'][0]['stars'] > 0, (__t) {
      var __e139;
      __e139 = new autogenerated.Element.html('<x-membro-emblema classe="item-emblema1"></x-membro-emblema>');
    ...
    __t.conditional(__e142, () => membro['achievementsRole'][0]['stars'] > 0, (__t) {
      var __e141;
      __e141 = new autogenerated.Element.html('<x-membro-emblema classe="item-emblema2"></x-membro-emblema>');
