...
void init_autogenerated() {
  ...
  final __html0 = new autogenerated.Element.html('<div is="x-pagina-clube"></div>'), __html1 = new autogenerated.Element.html('<div is="x-pagina-anuncios"></div>'), __html2 = new autogenerated.Element.html('<div is="x-pagina-jogos"></div>'), __html3 = new autogenerated.Element.html('<div is="x-pagina-membros"></div>'), __html4 = new autogenerated.Element.html('<div is="x-pagina-equipas"></div>'), __html5 = new autogenerated.Element.html('<div is="x-pagina-galeria"></div>'), __html6 = new autogenerated.Element.html('<div is="x-pagina-forum"></div>'), __html7 = new autogenerated.Element.html('<div is="x-pagina-inscricoes"></div>'), __html8 = new autogenerated.Element.html('<div is="x-pagina-documentos"></div>'), __html9 = new autogenerated.Element.html('<div is="x-pagina-contas"></div>');
  var __e0, __e1, __e11, __e13, __e15, __e17, __e19, __e21, __e3, __e5, __e7, __e9;
  var __t = new autogenerated.Template(_root);
  __e0 = _root.nodes[5].nodes[1];
  __t.component(new SiteHeader()..host = __e0);
  __e1 = _root.nodes[5].nodes[3];
  __t.component(new SiteNavigation()..host = __e1);
  __e3 = _root.nodes[5].nodes[7].nodes[1];
  __t.conditional(__e3, () => model.hash==''||model.hash.startsWith(NavLink.Clube.link), (__t) {
    var __e2;
    __e2 = __html0.clone(true);
    __t.component(new PaginaClube()..host = __e2);
  __t.add(__e2);
  });

  __e5 = _root.nodes[5].nodes[7].nodes[3];
  __t.conditional(__e5, () => model.hash.startsWith(NavLink.Anuncios.link), (__t) {
    var __e4;
    __e4 = __html1.clone(true);
    __t.component(new PaginaAnuncios()..host = __e4);
  __t.add(__e4);
  });

  __e7 = _root.nodes[5].nodes[7].nodes[5];
  __t.conditional(__e7, () => model.hash.startsWith(NavLink.Jogos.link), (__t) {
    var __e6;
    __e6 = __html2.clone(true);
    __t.component(new XPaginaJogos()..host = __e6);
  __t.add(__e6);
  });

  __e9 = _root.nodes[5].nodes[7].nodes[7];
  __t.conditional(__e9, () => model.hash.startsWith(NavLink.Membros.link), (__t) {
    var __e8;
    __e8 = __html3.clone(true);
    __t.component(new PaginaMembros()..host = __e8);
  __t.add(__e8);
  });

  __e11 = _root.nodes[5].nodes[7].nodes[9];
  __t.conditional(__e11, () => model.hash.startsWith(NavLink.Equipas.link), (__t) {
    var __e10;
    __e10 = __html4.clone(true);
    __t.component(new XPaginaEquipas()..host = __e10);
  __t.add(__e10);
  });

  __e13 = _root.nodes[5].nodes[7].nodes[11];
  __t.conditional(__e13, () => model.hash.startsWith(NavLink.Galeria.link), (__t) {
    var __e12;
    __e12 = __html5.clone(true);
    __t.component(new PaginaGaleria()..host = __e12);
  __t.add(__e12);
  });

  __e15 = _root.nodes[5].nodes[7].nodes[13];
  __t.conditional(__e15, () => model.hash.startsWith(NavLink.Forum.link), (__t) {
    var __e14;
    __e14 = __html6.clone(true);
    __t.component(new XPaginaForum()..host = __e14);
  __t.add(__e14);
  });

  __e17 = _root.nodes[5].nodes[7].nodes[15];
  __t.conditional(__e17, () => model.hash.startsWith(NavLink.Inscricoes.link), (__t) {
    var __e16;
    __e16 = __html7.clone(true);
    __t.component(new XPaginaInscricoes()..host = __e16);
  __t.add(__e16);
  });

  __e19 = _root.nodes[5].nodes[7].nodes[17];
  __t.conditional(__e19, () => model.hash.startsWith(NavLink.Documentos.link), (__t) {
    var __e18;
    __e18 = __html8.clone(true);
    __t.component(new XPaginaDocumentos()..host = __e18);
  __t.add(__e18);
  });

  __e21 = _root.nodes[5].nodes[7].nodes[19];
  __t.conditional(__e21, () => model.hash.startsWith(NavLink.Contas.link), (__t) {
    var __e20;
    __e20 = __html9.clone(true);
    __t.component(new PaginaContas()..host = __e20);
  __t.add(__e20);
  });
